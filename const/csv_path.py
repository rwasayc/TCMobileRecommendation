...
TRAIN_USER_CSV_PATH = '../Tianchi-BigData/data/fresh_comp_offline/tianchi_fresh_comp_train_user.csv'
...
TRAIN_USER_DF_CSV_THIRD_DATA = '%s/train/p3_user_data.csv' % SAVE_BASE_PATH
TRAIN_USER_DF_CSV_THIRD_LABEL = '%s/train/p3_user_data.csv' % SAVE_BASE_PATH
...
def init_path():
    ...
    if not os.path.isdir('%s/train' % SAVE_BASE_PATH):
        os.makedirs('%s/df' % SAVE_BASE_PATH)
